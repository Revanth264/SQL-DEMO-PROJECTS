...
#helps to get number of employees
...
SELECT SUM(Salary) AS TotalSalaryAbove30
FROM Employees
WHERE Age > 30;
...
SELECT FirstName AS "First Name", LastName AS "Last Name", Salary AS "Employee Salary"
FROM Employees;
SELECT E.FirstName, E.LastName, E.Salary
FROM Employees E;
SELECT E.FirstName AS "Employee First Name", E.LastName AS "Employee Last Name", E.Salary AS "Employee Salary"
FROM Employees E;

SELECT E.FirstName AS "Employee Name", D.DepartmentName AS "Department"
FROM Employees E
JOIN Departments D
